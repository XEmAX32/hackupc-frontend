   ...
   <>
    <div class="rectangular-container" style={{width: '90%', padding: 0}}>
      ...
      <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'space-between'}}>
        <div style={{borderRight: '2px solid #000', width: '30%', paddingLeft: 10, paddingRight: 10, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center'}}>
          <div className="special" style={{fontSize: 30, marginBottom: 10}}>You found a Key! 🗝.</div>
          <div className="description" style={{textAlign: 'center'}}>Copy all 3 keys on the door’s security to escape from here.</div>
        </div>
